...
public class InicioSesionUserinterface {
    ...
    public static final Target BTN_INGRESAR = Target.the("Boton ingresar al sistema").located(By.xpath("//button[@class = 'oxd-button oxd-button--medium oxd-button--main orangehrm-login-button']"));
}
